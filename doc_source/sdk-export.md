...
The following example shows how to use the [ExportCertificate](http://docs.aws.amazon.com/acm/latest/APIReference/API_ExportCertificate.html) function\. The function exports a private certificate issued by a private certificate authority \(CA\)\. It also exports the certificate chain and private key\. In the example, the passphrase for the key is stored in a local file\. 
