...
When you request a certificate from ACM and choose email validation, domain validation email is sent to three contact addresses specified in WHOIS and to five common administrative addresses\. For more information, see [Option 2: Email validation](email-validation.md)\. If you are experiencing problems receiving validation email, review the suggestions that follow\.
...
## Persistent initial timestamp for email validation<a name="initial-dates"></a>
